...
```bash
pip install "commoner-analyse @ git+https://github.com/CommonerLLP/commoner-analyse.git@v2.8.2"
```
...
```bash
pip install "commoner-analyse[pdf] @ git+https://github.com/CommonerLLP/commoner-analyse.git@v2.8.2"
```

Pin the same line in a project's `requirements.txt`:

```text
commoner-analyse[http,pdf] @ git+https://github.com/CommonerLLP/commoner-analyse.git@v2.8.2
```
